...
import jimtrade.com.jimtrade.Inquiry.Already_Registered;
import jimtrade.com.jimtrade.Inquiry.Register_Now;
import jimtrade.com.jimtrade.R;
import jimtrade.com.jimtrade.SlidingTabLayout;


public class Categories_Sliding_Fragments extends Fragment {
    ...
    public class SamplePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public android.support.v4.app.Fragment getItem(int position)
        {
            ...
            {
                case 0:
                    return Subscribed.newInstance(0, "Subscribed Categories");

                case 1:
                    return Add_category.newInstance(1, "Add Categories");
