...
public class Send_Inquiry_Supplier extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send__inquiry__supplier);
                ...
                public void onClick(View view) {
                    ...
                    try {
                        ...
                        if (box1.isChecked()) {
                            ...
                            final String sample = s7 + "," + z5 + "," + "0" + "," + Inquiry_dat + "," + chkBestResponse;
    ...
    class Senddata extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            // custom dialog
            dialog = new Dialog(Send_Inquiry_Supplier.this);
                        ...
                        for (int i = 0; i <= categories.length(); i++) {
                            ...
                            if (success.contains("success"))
                            {
                                ...
                                String html = "<html>\n" +
                                        ...
                                        "<b>\n" +
                                        "Date : </b>\n" +
                                        "</td>\n" + "<td style=\"padding-top:10px;font-size:13px; font-family:Arial, Helvetica, sans-serif;\">" +
                                        date + "   " + time + "</td>" +
                                        "</tr>\n" +
                                        "<tr>\n" +
                                        "<td width='25%'  align='left' valign='top' style='padding-top:10px;padding-left:10px;font-size:13px; font-family:Arial, Helvetica, sans-serif;'>\n" +
                                        ...
                                        " </table>\n" +
                                        "<br>\n" +
                                        "<table width='100%' cellspacing='0' border='0' cellpadding='0' style='border-bottom:1px solid #6DA6D6;font-size:13px; font-family:Arial, Helvetica, sans-serif;'>\n" +
                                        "<tr>\n" +
                                        ...
                                        "</tr>\n" +
                                        "<tr>\n" +
                                        "<td align='left' valign='top'  style='padding-top:10px;width:30%;font-size:13px; font-family:Arial, Helvetica, sans-serif;padding-left:10px;' nowrap'>\n" +
                                        "<b>\n" +
                                        "Company : </b>\n" +
                                        "</td>\n" + "<td style=\"padding-top:10px;font-size:13px; font-family:Arial, Helvetica, sans-serif;\">" +
                                        s2 + "</td>" +
                                        ...
                                        "</tr>\n" +
                                        "<tr>" +
                                        "<td align='left' valign='top' style='padding-top:10px;width:30%;font-size:13px; font-family:Arial, Helvetica, sans-serif;width:25%;padding-left:10px;' nowrap>" +
                                        "<b>" +
                                        "Email : </b>" +
                                        "</td>" +
                                        "<td style='width:75%'>" +
                                        "<a href='mailto:" + s1 + "?bcc=support@jimtrade.com&subject=Reply to Inquiry through JimTrade.com' style='font-size:13px; font-family:Arial, Helvetica, sans-serif;width:25%;'>" +
                                        ""+ s1 + "</a>" +
                                        ...
                                        "&nbsp;&nbsp;<a href='mailto:" + s1 + "?bcc=support@jimtrade.com&subject=Reply to Inquiry through JimTrade.com' style='font-family:Arial, Helvetica, sans-serif; font-size:18px; text-align:center; background:#DFEBF9; border:1px solid #DFEBF9; border-radius:3px;text-decoration:none; color:#000000;padding:10px;'>" +
                                        "Reply to Inquiry</a>" +
                                        " </td>" +
                                        "</tr>" +
                                        "<tr>" +
                                        ...
                                        "<br>\n" +
                                        "JimTrade.com<br>\n" +
                                        "India's Largest Online Business Directory</div>\n" +
                                        "<br>\n" +
                                ...
                                final String subject = z2 + "  Trade Inquiry through JimTrade.com";
                                final String message = Html_message;
                                final String subject1 = "Confirmation of Trade Inquiry sent by you";
                                ...
                                final String message1= "<html>\n" +
                                        ...
                                        "<td valign='top'  bgcolor='#E7EFF8' width='600' height='41' style='text-align:center;border-left:solid #6DA6D6 1px; border-right:solid #6DA6D6 1px; border-top:solid #6DA6D6 1px; padding:0 0; word-break:break-all;'>\n" +
                                        "<div align='center' style='height:41;padding:6px 0px; font-size:22px; font-family:Arial, Helvetica, sans-serif;line-height:22px; color:#206D9F;text-align:center'>\n" +
                                        "Confirmation of Trade Inquiry sent by you</div>\n" +
                                        "</td>\n" +
                                        "</tr>\n" +
                                        "<tr>\n" +
                                        "<td width='600' style='border-left:solid #6DA6D6 1px; border-right:solid #6DA6D6 1px; padding:12px;'>\n" +
                                        ...
                                        "<br>\n" +
                                        "<table width='100%' cellspacing='6' border='0' cellpadding='2' style='border-bottom:1px solid #6DA6D6;'>\n" +
                                        "<tr>\n" +
                                        "<td colspan='2' bgcolor='#E7EFF8'>\n" +
                                        "<div style='font-size:14px;color:#206D9F;'>\n" +
                                        "<strong>\n" +
    ...
    private class SendMailTask extends AsyncTask<Message, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            try {
                ...
                dialog2 = new Dialog(Send_Inquiry_Supplier.this);
    ...
    private class SendMailTask1 extends AsyncTask<Message, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            // custom dialog
            dialog1 = new Dialog(Send_Inquiry_Supplier.this);
