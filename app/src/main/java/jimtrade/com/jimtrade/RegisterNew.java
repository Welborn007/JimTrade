...
public class RegisterNew extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button sendButton = (Button) findViewById(R.id.button_register);
        Button resetButton = (Button) findViewById(R.id.button_reset);

        final EditText e1 = (EditText) findViewById(R.id.Edt_Company);
        final EditText e2 = (EditText) findViewById(R.id.Contact_Person_Edt);
        final EditText e3 = (EditText) findViewById(R.id.Design_edt);
        final EditText e4 = (EditText) findViewById(R.id.email_edt);
        final EditText e5 = (EditText) findViewById(R.id.pass_edt);
        final EditText e6 = (EditText) findViewById(R.id.cont_no_edt);
        final EditText e7 = (EditText) findViewById(R.id.address_edt);
        ...
        try {
            sendButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    final String s1 = sharedpreferences.getString("status", null);
    ...
    public boolean isEmailValid(String email) {
        ...
        if (matcher.matches()) {
            ...
            Toast.makeText(RegisterNew.this, "Enter proper email-id", Toast.LENGTH_SHORT).show();
        }
        return isValid;
    }
    ...
    private boolean isEmptyField (EditText editText){
        ...
        if (result)
            Toast.makeText(RegisterNew.this, "Please Enter all details!", Toast.LENGTH_SHORT).show();
        return result;
    }
    ...
    class Senddata extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            // custom dialog
            dialog = new Dialog(RegisterNew.this);
        ...
        protected void onPostExecute(final String response) {
            ...
            try {
                if (isNetworkStatusAvialable (RegisterNew.this)) {

                    JSONArray categories = new JSONArray(response);

                    if(categories.length() <= 0 )
                    {
                        Toast.makeText(RegisterNew.this, "Email id Already Registered", Toast.LENGTH_LONG).show();
                    }
                    ...
                    if (categories != null) {
                        ...
                        for (int i = 0; i <= categories.length(); i++) {
                            ...
                            {
                                Toast.makeText(RegisterNew.this, "Successfully registered", Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(RegisterNew.this,HomeScreen.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                startActivity(intent);
                                finish();
                            }
                            ...
                            {
                                Toast.makeText(RegisterNew.this, "Successfully registered", Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(RegisterNew.this,OTP.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                startActivity(intent);
                                finish();
                            }
                ...
                {
                    Toast.makeText(RegisterNew.this,"Check Internet Connectivity!!",Toast.LENGTH_LONG).show();
                }
