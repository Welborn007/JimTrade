...
import jimtrade.com.jimtrade.Products_contents.Product_Info_Activity;
import jimtrade.com.jimtrade.Products_contents.Product_details_fragment;
import jimtrade.com.jimtrade.Products_contents.Supplier_details_Fragment_Product_Screen;


public class ProductSlidingFragments extends Fragment
{
    ...
    public class SamplePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public android.support.v4.app.Fragment getItem(int position)
        {
            ...
            {
                case 0:
                    return Product_Info_Activity.newInstance(0, "Product Info");
                case 1:
                    return Product_details_fragment.newInstance(1, "Product Details");
                case 2:
                    return Supplier_details_Fragment_Product_Screen.newInstance(2, "Supplier Details");
                default:
                    return null;
            }
