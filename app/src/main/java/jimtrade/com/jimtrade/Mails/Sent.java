...
public class Sent extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            final String memberID = sharedpreferences.getString("mem_id", null);
    ...
    class LoadInquiries extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(final String response) {
            ...
            current_page += 1;
            final String url = "http://m.jimtrade.com/mobileapp.svc/getmembersentitems/" + memberID + "," + current_page;
                            ...
                            try
                            {
                                if (isNetworkStatusAvialable (getApplicationContext())) {
                                    ...
                                    for (int i = 0; i < response.length() && response.length() != 0; i++)
                                    {
                                        ...
                                        receive.setName(c.getString(TAG_SUPPLIER_NAME));
                                        ...
                                        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                            ...
                                            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                                Intent intent = new Intent(getApplicationContext(), Sent_body.class);
